...
go_repository(
    name = "com_github_victorspringer_http_cache",
    importpath = "github.com/victorspringer/http-cache",
    sum = "h1:Pg/LJmFZnr+hlP9sohJKDaxi1nTSOPvGNo8dBBgRIkM=",
    version = "v0.0.0-20190721184638-fe78e97af707",
)
...
go_repository(
    ...
    sum = "h1:lGeO5kht5JEY9CjA3mFs7C+4YTKmZYdyziu+sU3Dm8Y=",
    version = "v0.16.10",
)
...
go_repository(
    ...
    sum = "h1:dBXM+QSvfQHADv7DvUrtPqboFCT9wyicmT6zccOa9Zk=",
    version = "v0.16.10",
)
...
go_repository(
    ...
    sum = "h1:Yg7QJra/cXtiRiztzBbquH+cJby0PmTIMFKqhMj2Nxc=",
    version = "v0.16.10",
)
...
go_repository(
    ...
    sum = "h1:qExjnYJYFxu1OvSvqZTmzfSiF2YFLbCr5XzNfEE1wSI=",
    version = "v0.16.10",
)
...
go_repository(
    ...
    sum = "h1:4kgN8/a1iSnX2Trptc8nnoXnOGXkrcaF0u4+dmiCRRA=",
    version = "v0.0.0-20200529193333-24a76e807f40",
)
...
go_repository(
    ...
    sum = "h1:JxsyO7zPDWn1rBZW8FV5RFwCKqYeXnyaS/VQPLpXu6I=",
    version = "v0.0.0-20200329125638-4c31acba0007",
)
...
go_repository(
    ...
    sum = "h1:Wec8/IO8hAraBf0it7/dPQYOslIrgM938wZYNkLnOYc=",
    version = "v0.0.0-20200530233709-52effbd89c51",
)
...
go_repository(
    ...
    sum = "h1:y158/g9tKwBGw9gnNENlUIi9NTJCoiQg2RFB1gr9atQ=",
...
go_repository(
    ...
    sum = "h1:N7tNfo+nO3K7PhBHcc7qoElM9bAsz4Ryqx7Zriu0QHs=",
    version = "v0.16.10",
)
...
go_repository(
    ...
    sum = "h1:8ywu4ELC/6owgOZlZx75CyYS5AYwUT2L+hzPModKvag=",
    version = "v0.0.0-20200420212212-258d9bec320e",
)
...
go_repository(
    ...
    sum = "h1:nKIhaVknZ0wOBBg0Uu6px+t218SfkLh2i/JwwOXYXqs=",
    version = "v1.1.31",
)
...
go_repository(
    ...
    sum = "h1:Bbo8Hp5h62WB+EezHMURdGmuU7J2TMe7h+2vySwmwpk=",
    version = "v0.0.0-20191203043605-d42048ed14fd",
)
